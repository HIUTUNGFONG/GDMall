    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('nick_name', models.CharField(default='未命名用户', max_length=30, verbose_name='昵称')),
                ('head_portrait', models.CharField(default='未上传头像', max_length=255, verbose_name='用户头像')),
                ('birthday', models.CharField(default='', max_length=30, verbose_name='出生日期')),
                ('height', models.CharField(default='', max_length=10, verbose_name='身高')),
                ('weight', models.CharField(default='', max_length=10, verbose_name='体重')),
                ('phone', models.CharField(default=0, max_length=11, verbose_name='手机号码')),
