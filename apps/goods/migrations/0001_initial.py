# Generated by Django 2.0.6 on 2019-04-24 11:15
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('update_time', models.DateTimeField(auto_now=True, verbose_name='更新时间')),
                ('is_delete', models.BooleanField(default=False, verbose_name='删除标记')),
                ('show_region', models.CharField(choices=[(0, '产品大图'), (1, '产品图文')], max_length=30, verbose_name='展示区域')),
                ('image', models.ImageField(upload_to='GoodsImg', verbose_name='图片')),
                ('index', models.SmallIntegerField(default=0, verbose_name='展示顺序')),
                ('goods_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='goods.Goods', verbose_name='所属产品id')),
            ],
            options={
                'verbose_name': '产品图片',
